<template>
    <v-page-wrap crud absolute searchable with-progress>
        <template #navigate>
            <v-btn-tips class="mr-2" @click="$router.go(-1)" label="agency" icon="arrow_back" :show="true" />
        </template>
...
export default {
    name: 'page-agency-user',

    mixins: [pageMixins],

    route: [
        { path: 'agency/:agency/agency-user', name: 'agency-user', root: 'monoland' },
    ],
    ...
    created() {
        ...
        this.dataUrl(`/api/agency/${this.$route.params.agency}/user`);
