<template>
    <v-input
        class="v-input--is-label-active v-input--is-dirty v-text-field v-text-field--is-booted v-money"
        :class="[{ 'v-input--is-focused': isFocus, 'text-right': alignRight }, isFocus ? `${color}--text` : '']"
